...
int main()
{
	...
	for (int i = 0; i < iArray1Size; ++i)
	{
		...
		else if ((iArray1[i] >= 10 && iArray1[i + 1] >= 10 && iArray1[i + 2] >= 10) && (i + 2) < iArray1Size)
		{
			for (int j = 0; j < iArray1[i]; ++j)
				cout << "$";
			nBadCnt++;
		...
		else if ((iArray1[i - 1] >= 10 && iArray1[i] >= 10 && iArray1[i + 1] >= 10) && (i - 1) >= 0 && (i + 1) < iArray1Size)
		{
			for (int j = 0; j < iArray1[i]; ++j)
				cout << "$";
			nBadCnt++;
		...
		else if ((iArray1[i - 2] >= 10 && iArray1[i - 1] >= 10 && iArray1[i] >= 10) && (i - 2) >= 0)
		{
			for (int j = 0; j < iArray1[i]; ++j)
				cout << "$";
			nBadCnt++;
